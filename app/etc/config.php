...
Disallow: /*SID=
            ...
            'general' => [
                ...
                'region' => [
                    'display_all' => '1',
                    'state_required' => 'AU,BR,CA,HR,EE,IN,LV,LT,RO,ES,CH,US',
                ],
                'store_information' => [
                    'name' => 'Blumen Claudia',
                    'phone' => '0043 (0)1 486 99 54',
                    'hours' => NULL,
                    'country_id' => 'AT',
                    'region_id' => '95',
                    'postcode' => NULL,
                    ...
                    'street_line1' => NULL,
                    'street_line2' => NULL,
                    'merchant_vat_number' => 'ATU 60541649',
                ],
            ],
            'theme' => [
                'customization' => [
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'msp_securitysuite_twofactorauth' => [
                ...
                'duo' => [
                    'application_key' => 'e9VcIY4FUpb57ISdG3NJoz60848WaLrubxRGnD4vHsqjphYiNelTRnNJRsRY0TEP',
                ],
            ],
            'contact' => [
                'contact' => [
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'Dc043w5cmHLq4HXXTIglQLQaKJfdWI4t',
